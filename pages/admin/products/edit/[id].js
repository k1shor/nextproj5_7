...
const edit = ({ product, categories }) => {
    ...
    useEffect(() => {
        ...
        sel_ref.current.value = product.category
        setProduct({ ...product, formdata: new FormData })
    ...
    let { title, price, description, count_in_stock, category, formdata } = productToUpdate
...
// let formdata = new FormData
    ...
    const showSuccess = () => {
        if (success) {
            return <div className="bg-green-200 text-center">Product Updated Successfully</div>
        }
    }
    ...
    //     sel_ref.current.value = category
            ...
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
                <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form>
                        ...
                        <div className="grid gap-4 mb-4 sm:grid-cols-1">
                            <img src={`http://localhost:5000/${product.image}`} alt={product.title} className="h-40" />
                            <div>
