...
// import { ADD_TO_CART } from "@/lib/features/cart/cart";
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    ...
                    <div class="mr-auto place-self-center lg:col-span-7">
                        ...
                        <h1>
                            <Rating name="half-rating-read" value={product.rating} precision={0.5} />
                        </h1>
                ...
                {/* related Product */}
                <h1 className="text-2xl underline my-5 text-center">Related Products</h1>
                {
